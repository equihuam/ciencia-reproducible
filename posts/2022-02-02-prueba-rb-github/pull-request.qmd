...
image: img/Pull-Request-Attlasian.webp
...
Para empezar a colaborar, lo primero es quue cada participante tenga suu propia copia (_fork_) del proyecto. Esto se puede hacer con la instrucción siguiente:
...
+ Definirá el _orígen remoto_ del repositorio vinculado a tuu copia en Github.
