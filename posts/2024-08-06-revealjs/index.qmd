...
:::{.fragment style="font-size:80px; color:white; text-align:center; padding-top:25%"}
**Jaguar**
:::

:::{.fragment style="font-size:40px; color:yellow; text-align:center; padding-top:-10%"}
Miguel Equihua
:::

:::{.fragment style="font-size:30px; color:cyan; text-align:center; padding-top:-30%"}
_6-agosto-2024_
:::
