...
1. **En Github** - En la configuración de aplicaciones, conceder acceso a Netlify al repositorio que te interesa sea la fuente de documentos para publicar.
2. **En Netlify** - Hay que configurar un nuevo sitio:
