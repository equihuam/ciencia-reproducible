...
A veces conviene ofrecer información adicional al lector, dándole la oportunidad de decidir cuándo o si es que la desea ver. Hay una colección de cajas de este tipo en _Quarto_ que se engloban en la conjunto [callout](https://quarto.org/docs/authoring/callouts.html). Su uso es mediante _fences_, el sistema de marcado que se inicia con `::: {_indicación_}` y se cierra con `:::`.

| tipo | llamada |
|------|---------|
|note      |::: {.callout-note}|    
|warning   |::: {.callout-waning}|
