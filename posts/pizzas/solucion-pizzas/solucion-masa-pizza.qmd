...
En esta libreta *RMarkdown* les comparto mis notas de lo que hice en relación con los datos de masa para pizza. Pongo aquí dos referencia que no tienen gran cosa que ver pero tienen valor ilustrativo [@pizzama2003], o cuando hablas de lo que dice @ceccarini2011.
...
Para tu referencia incluyo aquí información sobre como manejar el tema de las listas de [referencias bibliográficas en Quarto](https://quarto.org/docs/authoring/citations.html#sec-citations). Seguramente habrá necesidad de adecuarse a alguno de los múltiples estilos de citación que usan las revistas, muchos de ellos [están ya preparados en este repo](https://github.com/citation-style-language/styles). Si no lo encuuentras ahí puedes preparar el tuyo con [ayuda de Zootero](https://www.zotero.org/support/dev/citation_styles/style_editing_step-by-step) o la del [editor de Mendeley](https://www.mendeley.com/guides/csl-editor/). Lo que tendrás que hacer es buscar el `*.csl` de tu elección y descargarlo. Ponerlo en tu proyecto y listo. A continación está el bloque con el que _invocas_ la aparición de la lista de referencias. 
